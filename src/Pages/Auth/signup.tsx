...
const SignupPage: React.FC = () => {
  ...
  useEffect(() => {
    if (signupState && signupState?.data) {
      ...
      <div className="relative max-w-[28rem] w-full">
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 md:p-10">
          ...
          <Form className="space-y-6" onSubmit={validation.handleSubmit}>
            ...
            <div>
              <button type="submit" className="w-full inline-flex justify-center items-center px-4 py-3 bg-gradient-to-r from-indigo-600 to-blue-600 text-white rounded-lg shadow hover:opacity-95 disabled:opacity-60 font-medium"> Sign Up </button>
            </div>
